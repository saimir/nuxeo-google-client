...
/**
 * Converter that relies on {@link org.nuxeo.ecm.core.blob.ManagedBlobProvider} conversions.
 *
 * @since 7.3
 */
public class GoogleDriveBlobConverter implements Converter {
    ...
    protected Blob convert(ManagedBlob blob) throws IOException {
        ...
        ManagedBlobProvider blobProvider = blob.getBlobProvider();
        InputStream is = blobProvider.getConvertedStream(blob, mimetype);
